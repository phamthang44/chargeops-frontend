      ...
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled">
          ...
          <Text style={styles.subtitle}>
            Đăng nhập bằng email và mật khẩu để tiếp tục sử dụng dịch vụ sạc xe điện thông minh.
          </Text>
          ...
          <View style={styles.securityBadge}>
            ...
            <Text style={styles.securityText}>
              Thông tin của bạn được bảo mật tuyệt đối theo tiêu chuẩn mã hóa AES-256.
            </Text>
          </View>
        </ScrollView>

        <View style={styles.footer}>
          <AppButton label="Đăng nhập" onPress={handleLogin} loading={submitting} disabled={!canSubmit} style={styles.cta} />
